...
public class BoardServiceImp implements BoardService{
    ...
    public BoardImgDao boardImgDao;
    ...
    public int register(BoardDto board) throws Exception {
        ...
        // last_insert_id로 방금 저장된 게시글 번호를 불러와서 이미지 저장시 사용해야 한다.
    ...
    public BoardDto detail(int boardNo) throws Exception {
        ...
        List<BoardImgDto> boardImgList = boardImgDao.findByBoard(boardNo);  // join처럼 동작
