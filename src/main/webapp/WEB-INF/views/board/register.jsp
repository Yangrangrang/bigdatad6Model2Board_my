...
<body>
    ...
    <main class="container">
        ...
        <h2>BLOB과 multipart/form-data</h2>
        <ul>
            <li>BLOB : 바이너리 데이터를 text 인코딩으로 분석하지 않겠다. -> Text가 아닌 다른 파일(BLOB)도 형식으로 데이터를 분석하겠다.</li>
            <li>multipart/form-data : form에서 파라미터를 보낸때 파일도 같이 보내겠다.</li>
            <li>COS : 자바 서블릿에서 BLOBD으로 넘어온 파라미털를 처리해주는 라이브러리</li>
            <li>application/x-www-form-urlencoded :
                form에서 파라미터를 보내는 default 값으로
                queryString 형식으로 파라미터를 요청 본문 헤더에 포함해서 보낸다.
            </li>
            <li></li>
        </ul>
